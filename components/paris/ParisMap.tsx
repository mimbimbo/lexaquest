...
export function ParisMap({ bakeryComplete, onOpenBakery }: ParisMapProps) {
  return (
    <section className="relative mt-8 overflow-hidden rounded-[2rem] shadow-xl">
      ...
      <button className="absolute left-[65%] top-[43%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-stone-200/90 px-4 py-2 text-sm text-stone-500 shadow-lg">
        🏛️ Place
      </button>
